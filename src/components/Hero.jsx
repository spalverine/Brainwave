            ...
            <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                    <div className='relative bg-n-8 rounded-[1rem]'>
                        ...
                        <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>    {/*aspect-[33/40] is an aspect ratio property used in CSS. It sets the aspect ratio of the element to 33 units wide and 40 units high, and overflow hidden means that we can't scroll through it*/}
                            ...
                            </ScrollParallax>     {/*scrollparalax means that the component can scroll up and down*/}
