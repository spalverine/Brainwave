            ...
            <div className='relative'>
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                        <div className='absolute inset-0'>                                       {/*we use the absolute position to get more power and freedom to position something*/}
                            <img src={service2} className='h-full w-full object-cover' width={630} height={750} alt="robot" />
                        </div>

                        <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15'>
                            <h4 className='h4 mb-4'>Photo editing</h4>
                            <p className='body-2 mb-[3rem] text-n-3'>Automatically enhance your photos using our AI app&apos;s photo editing feature. Try it now!</p> {/*We use &apos; to do ' */}
                        </div>
                    ...
                    <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                        ...
                        <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>  {/*we used the relative position to style the videochatmessage and the video within this div*/}
