                ...
                <div className='flex items-center h-[5.5rem] mb-6'>
                    {item.price && (
                        <>
                            ...
                            <div className='text-[5.55rem] leading-none '>{item.price}</div>
                        </>
                    )}
                </div>

                <Button className='w-full mb-6' href={item.price ? '/pricing' : 'mailto:contact@jsmastery.pro'}  white={!!item.price}>  {/*!! used to turn any varibale into boolean in this case the first pricing lists have a price so they'll return to white*/}
